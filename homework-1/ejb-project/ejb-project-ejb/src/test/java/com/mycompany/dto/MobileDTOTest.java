...
public class MobileDTOTest {
    ...
    public void idNotNull(){
        ...
        ValidationTestHelper.onlyOneViolation(mobile, mobile.getId());
    }
    ...
    public void typeNotNull(){
        ...
        ValidationTestHelper.onlyOneViolation(mobile, mobile.getType());
    }
    ...
    public void manufactNotNull(){
        ...
        ValidationTestHelper.onlyOneViolation(mobile, mobile.getManufacturer());
    }
    ...
    public void priceMinOne(){
        ...
        ValidationTestHelper.onlyOneViolation(mobile, mobile.getPrice());
    }
    ...
    public void pieceMinZero(){
        ...
        ValidationTestHelper.onlyOneViolation(mobile, mobile.getPiece());
    }
