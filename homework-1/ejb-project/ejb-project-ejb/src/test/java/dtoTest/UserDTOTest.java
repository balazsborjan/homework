...
public class UserDTOTest {
    ...
    public void userNameNotNull(){
        ...
        ValidationTestHelper.notZeroViolations(user, user.getUserName());
    }
    ...
    public void userNameSizeMinThree(){
        ...
        ValidationTestHelper.notZeroViolations(user, usrnm);
    }
    ...
    public void passwordNotNull(){
        ...
        ValidationTestHelper.notZeroViolations(user, user.getPassword());
    }
    ...
    public void passwordMatchPattern(){
        ...
        ValidationTestHelper.notZeroViolations(user, pwd);
    }
    ...
    public void dateOfBirthShouldMatchIsValidDateOfBirth(){
        ...
        ValidationTestHelper.notZeroViolations(user, user);
    }
}
